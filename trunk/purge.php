...
<table summary="">
	<tr>
      ...
      $ids = array_merge ( $E_ids, $M_ids );
		...
		<table>
			<tr>
				<td><label for="user"> <?php echo translate ( 'User' );?>:</label></td>
			...
			<tr>
				<td><label for="purge_all"> <?php etranslate ( 'Check box to delete ALL events for a user' )?>:</label></td>
				<td valign="bottom"><input type="checkbox" name="purge_all"
					value="Y" id="purge_all"
					onclick="toggle_datefields( 'dateArea', this );" /></td>
			</tr>
			<tr id="dateArea">
				<td><label> <?php etranslate ( 'Delete all events before' );?>:</label></td>
				<td><?php echo date_selection ( 'end_', date ( 'Ymd' ) ) ?></td>
			</tr>
			<tr>
				<td><label for="purge_deleted"> <?php etranslate ( 'Purge deleted only' )?>:</label></td>
				<td valign="bottom"><input type="checkbox" name="purge_deleted"
					value="Y" /></td>
			</tr>
			<tr>
				<td><label for="preview"> <?php etranslate ( 'Preview delete' )?>:</label></td>
				<td valign="bottom"><input type="checkbox" name="preview" value="Y"
					checked="checked" /></td>
			</tr>
			<tr>
    ...
    ?> ' + document.forms[0].username.value + '?' )" /></td>
			</tr>
		</table>
		</form>
