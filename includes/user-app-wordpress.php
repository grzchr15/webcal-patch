...
// *** NOTE:
// webcal must be installed somewhere in the blog root directory to read
// wordpress's cookie OR edit wordpress to make the cookie global:
//   change line ??? in ????.php to:
...
// config.php file
$app_config = '';
$config_lines = file( $app_path . "wp-config.php" );
...
function app_login_screen( $return ) {
	global $SERVER_URL;
	header ( "Location: {$SERVER_URL}/wp-admin/?return_path={$return}");
	exit;
}
